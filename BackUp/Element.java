...
public class Element implements Comparable {
	...
	private DoubleWrapper bpa;
	private DoubleWrapper belief;
	private DoubleWrapper plausability;

	public Element(ArrayList<Hypothesis> hypothesies, DoubleWrapper bpa) {
		super();
		setBpa(bpa);
	 ...
	 * @param bpa
	 */
	public void setBpa(DoubleWrapper bpa) {
		this.bpa = bpa;

	}

	public DoubleWrapper getBelief() {
		return belief;
	}

	public void setBelief(DoubleWrapper belief) {
		this.belief = belief;
	}

	public DoubleWrapper getPlausability() {
		return plausability;
	}

	public void setPlausability(DoubleWrapper plausability) {
